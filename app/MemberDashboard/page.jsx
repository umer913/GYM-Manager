        ...
        <main className="flex-1 px-4 sm:px-8 py-6 space-y-5 max-w-6xl w-full mx-auto">
          ...
          <div className="relative rounded-2xl overflow-hidden border border-zinc-800/80 shadow-[0_0_40px_rgba(220,38,38,0.08)]">
            ...
            <div className="relative z-10 p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center gap-6">
                ...
                <div className="mt-4 flex flex-wrap items-center gap-2">
                  {member.plan ? (
                    <span className={`inline-flex items-center gap-1.5 text-xs px-3 py-1 rounded-full font-bold border ${
                      ...
                      {member.plan.name} — {member.plan.allowsTrainer ? "Premium" : "Standard"}
                    </span>
                  ) : (
              ...
              {/* quick stats — styled like plan price blocks on home page */}
              <div className="flex sm:flex-col gap-3 shrink-0">
                <div className="relative p-[1px] rounded-xl bg-gradient-to-br from-zinc-700 to-zinc-900 hover:from-red-500/40 hover:to-orange-500/20 transition-all duration-300 min-w-[88px]">
                  <div className="rounded-xl bg-zinc-950/95 px-4 py-3 text-center">
                    <p className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-400 leading-none">{weekCount}</p>
                    <p className="text-[10px] text-zinc-500 mt-1 uppercase tracking-wide">This week</p>
                  </div>
                </div>
                <div className="relative p-[1px] rounded-xl bg-gradient-to-br from-zinc-700 to-zinc-900 hover:from-red-500/40 hover:to-orange-500/20 transition-all duration-300 min-w-[88px]">
                  <div className="rounded-xl bg-zinc-950/95 px-4 py-3 text-center">
                    <p className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-400 leading-none">{totalCheckIns}</p>
                    <p className="text-[10px] text-zinc-500 mt-1 uppercase tracking-wide">All time</p>
                  </div>
                </div>
              </div>
            </div>
