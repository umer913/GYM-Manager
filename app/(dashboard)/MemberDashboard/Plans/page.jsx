...
export default function MemberPlansPage() {
  ...
  const THEMES = {
    "normal": {
      card: "",
      cardActive: "border-red-500/30 bg-red-500/10",
      cardInactive: "border-zinc-800/80 bg-zinc-900/60 hover:border-zinc-700",
      gradient: "from-red-600 to-orange-600 hover:from-red-500 hover:to-orange-500",
      accent: "from-red-500 to-orange-500",
      badge: "bg-orange-500/10 text-orange-400 border-orange-500/20",
    },
    "good": {
      card: "shadow-lg shadow-red-500/5",
      cardActive: "border-red-500/40 bg-gradient-to-br from-red-500/15 to-orange-500/5",
      cardInactive: "border-zinc-700/80 bg-gradient-to-br from-zinc-900/80 to-zinc-900/40 hover:border-zinc-600 hover:shadow-lg hover:shadow-red-500/5",
      gradient: "from-red-500 to-orange-500 hover:from-red-400 hover:to-orange-400",
      accent: "from-red-400 to-orange-400",
      badge: "bg-gradient-to-r from-orange-500/20 to-red-500/10 text-orange-300 border-orange-500/30",
    },
    "very-good": {
      card: "shadow-xl shadow-red-500/10",
      cardActive: "border-amber-500/40 bg-gradient-to-br from-red-500/20 via-amber-500/5 to-orange-500/10 ring-1 ring-amber-500/20",
      cardInactive: "border-zinc-700/80 bg-gradient-to-br from-zinc-900/80 via-zinc-900/50 to-zinc-950/80 hover:border-amber-600/30 hover:shadow-xl hover:shadow-amber-500/5 hover:ring-1 hover:ring-amber-500/10",
      gradient: "from-red-500 via-amber-500 to-orange-500 hover:from-red-400 hover:via-amber-400 hover:to-orange-400",
      accent: "from-red-400 via-amber-400 to-orange-400",
      badge: "bg-gradient-to-r from-amber-500/20 via-orange-500/20 to-red-500/10 text-amber-300 border-amber-500/30",
    },
  };
  const getTheme = (t) => THEMES[t] || THEMES.normal;
          ...
          <section className="rounded-2xl bg-zinc-900/60 border border-zinc-800/80 p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              {filteredPlans.length === 0 ? (
                ...
                return (
                  <div key={plan.id} className={`rounded-2xl border p-5 transition ${t.card} ${isActive ? t.cardActive : t.cardInactive}`}>
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="text-right">
                        <p className={`text-xl font-black text-transparent bg-clip-text bg-gradient-to-r ${t.accent}`}>Rs {plan.price.toLocaleString()}</p>
                    ...
                    <button
                      ...
                      className={`mt-4 w-full py-3 rounded-xl text-sm font-bold border transition cursor-pointer disabled:cursor-not-allowed disabled:opacity-60 ${
                        isActive && isSubscribed
                          ...
                          : `bg-gradient-to-r ${t.gradient} text-white border-transparent shadow-lg shadow-red-500/20`
                      }`}
                    >
