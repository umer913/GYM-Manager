...
const NAV_LINKS = [
  {
    ...
    label: "Dashboard", path: "/TrainerDashboard",
  },
  {
    icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
    ...
    label: "Assigned Members", path: "/TrainerDashboard/AssignedMembers",
  },
  {
    icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
    ...
    label: "Attendance", path: "/TrainerDashboard/Attendance",
  },
  {
    icon: (
      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
    ...
    label: "Profile", path: "/TrainerDashboard/Profile",
  },
];
      ...
      {trainer && (
        <div className="flex items-center gap-3 px-3 py-2.5 mb-6 rounded-xl bg-zinc-900 border border-zinc-800">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-white truncate">{trainer.name}</p>
            <p className="text-[10px] text-zinc-500 truncate">{trainer.specialty}</p>
          </div>
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-zinc-950 border-b border-zinc-800/80 px-4 h-14 flex items-center justify-between">
        <button onClick={() => handleNav("/TrainerDashboard")} className="flex items-center gap-2 cursor-pointer group">
